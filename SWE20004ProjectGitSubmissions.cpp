	...
	for ( ; ; )
	{
		...
		case 4:
		{
			...
			*/
			...
			fstream updatepatdata;
			updatepatdata.open("TempFileCovidTestAndStatus.txt", ios::trunc);
			cout << "Enter your detail for COVID-Test Recommendation\n\n" << endl;
			...
			// Patient Test Result
			cout << "\nDo you have a Covid Test result:\n" << endl;
			getline(cin, pCovidTest);
			...
			updatepatdata <<"\n"<< pId << "\t" << pCovidTest << "\t" << pStatus << endl;

			updatepatdata.close();
			cout << "\n...............Updated COVID Patient Details.................\n\n" << endl;
			break;
		}
		case 5:
		{
			...
			/*
			*/
			cout << "\n.................Displaying the COVID Positive Patient Detail...................\n\n" << endl;
			string Positive;
			int ID;
            ifstream infile;
            ifstream infile2;
            ...
            infile.open("TempFileCovidTestAndStatus.txt");

            while (getline(infile, Positive))
            {
    
            if (Positive.find("Positive") != std::string::npos)
            {  //cout << "ID : " << Positive << endl;
                string s = Positive;
                stringstream ss(s);
                string idextract;
                if(ss >> idextract) {
                    infile2.open("Patients.txt");
                    //cout << idextract << endl;
                    while(getline(infile2,det)){
                        if(det.find(idextract) != std::string::npos){
                        cout<<det<<endl;
                    }
